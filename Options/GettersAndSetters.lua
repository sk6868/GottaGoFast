...
function GottaGoFast.GetTrueTimer()
  ...
  if (timerType == "TrueTimerNoMS") then
    return true;
  else
    return false;
  end
...
function GottaGoFast.SetTimerTooltip(info, value)
  ...
  if (value) then
	...
	GottaGoFastFrame:SetScript("OnEnter", nil);
    GottaGoFastFrame:SetScript("OnLeave", nil);
  end
end
